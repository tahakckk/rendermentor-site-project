        ...
        "columns": [
            ...
            },
            {
                ...
                "render": function (data, type, row) {
                    return `
                        <a href="/Admin/Faq/Upsert/${row.id}">${row.question}</a>
                        `;
                }, "width": "83%"
            },
            {
                ...
                "render": function (data) {
                    return `
                        <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                            <a href="/Admin/Faq/Upsert/${data}" class="btn btn-info"><i class="fa fa-edit"></i> Düzenle</a>
                            <a onclick=Delete("/Admin/Faq/Delete/${data}") class="btn btn-danger text-white"><i class="fa fa-trash"></i> Sil</a>
